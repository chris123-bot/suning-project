    ...
    <div class="prodetail iconfont" ref="scrollDiv">
        ...
        <div class="proimg" ref="proScroll">
            ...
            <div class="proimg-lunbo" v-if="proList">
                <swiper ref="mySwiper" :options="swiperOptions" class="my-swiper">
                    <swiper-slide
                        class="lunbo-pic"
                        v-for="(item,index) in proList.images"
                        :key="'img'+index"
                    >
                        <img :src="item" alt />
                    </swiper-slide>
            ...
            <swiper ref="mySwiper" :options="recomSwiperOptions" class="recom-swiper">
                ...
                <swiper-slide class="recom-lunbo">
                    <div class="store-recom">
                        <div>
                            <img
                                src="//imgservice.suning.cn/uimg1/b2c/image/diCm2VIDHr8iuXZz9RRFmw.jpg_200w_200h_4e_100Q_is"
                                alt
                            />
            ...
            <swiper ref="mySwiper" :options="recomSwiperOptions" class="recom-swiper">
                ...
                <swiper-slide class="recom-lunbo">
                    <div class="store-recom">
                        <div>
                            <img
                                src="//imgservice.suning.cn/uimg1/b2c/image/8oQ0z1yggDu9OekOpRezTw.jpg_200w_200h_4e_100Q_is"
                                alt
                            />
        ...
        <div class="prodetail-bottom">
            ...
            <div class="buy-add">
                ...
                <div @click="addCart(proList)" class="buy2">
