        ...
        <template>
            <div class="index-bottom">
                ...
                <div @click="changeCom('classify')">
                    <img
                        v-if="comName=='/classify'"
                        src="../images/bottomImg/magglass-yellow.png"
                        alt
                    />
                ...
                <template v-if="comName=='/favorite'">
                    <div @click="changeCom('rankinglist')">
                        <a
                            href="https://c.m.suning.com/phbChannel.html?safp=f73ee1cf.wapindex7.113464329889.3&safpn=10001"
                        >
                            <img
                                v-if="comName=='rankinglist'"
                                src="../images/bottomImg/ranklist-yellow.png"
                                alt
                            />
                ...
                <template v-else>
                    <div @click="changeCom('roblist')">
                        <a
                            href="https://c.m.suning.com/channel/higoubq11.html?safp=f73ee1cf.20291.0.4933f378d4&safpn=10006"
                        >
                            <img
                                v-if="comName=='rankinglist'"
                                src="../images/bottomImg/ranklist-yellow.png"
                ...
                <div @click="changeCom('mine')">
                    <img
                        v-if="comName=='/mine'||comName=='/enter'"
                        src="../images/bottomImg/mine-yellow.png"
                        alt
                    />
